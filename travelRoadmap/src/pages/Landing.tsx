...
import { ChevronRight, ChevronDown, MapPin, Calendar, DollarSign, Star, Shield, Sparkles, Play, Mail } from 'lucide-react';
import { motion } from 'framer-motion';
import AnimatedPage from '../components/AnimatedPage';
import StarRating from '../components/StarRating';
import { TRAVEL_QUOTES, HERO_IMAGES, HERO_VIDEO_URL } from '../data/mockData';
            ...
            <section className="py-24 page-bg">
                <div className="section-container">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {reviews.slice(0, 6).map((review: AppReview, i: number) => (
                            <motion.div
                                key={review.id}
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
